...
from hivememory.engines.lifecycle.orchestrator import MemoryLifecycleManager, create_default_lifecycle_manager
...
class TestCreateDefaultLifecycleManager:
    ...
    @patch('hivememory.engines.lifecycle.garbage_collector.create_default_garbage_collector')
    @patch('hivememory.engines.lifecycle.archiver.create_default_archiver')
    @patch('hivememory.engines.lifecycle.reinforcement.create_default_reinforcement_engine')
    @patch('hivememory.engines.lifecycle.vitality.create_default_vitality_calculator')
    @patch('hivememory.patchouli.config.MemoryLifecycleConfig')

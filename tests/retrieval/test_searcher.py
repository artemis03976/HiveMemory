...
class TestHybridSearcher:
    ...
    def setup_method(self):
        ...
        self.searcher = HybridSearcher(storage=self.mock_storage)
    ...
    def test_match_reason(self):
        ...
        assert "标签命中" in results.results[0].match_reason
        assert "t1" in results.results[0].match_reason

...
from hivememory.retrieval.retriever import HybridRetriever, CachedRetriever, SearchResult, SearchResults
...
class TestHybridRetriever:
    ...
    def test_search_hybrid(self):
        ...
        query = ProcessedQuery(semantic_query="test", original_query="test", filters={})

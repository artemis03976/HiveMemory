...
async def test_workspace_labels_share_subscription_and_sequence() -> None:
    ...
    publisher.bind(workspace_id="main_workspace").emit(RuntimeEventType.CHAT_RUN_CREATED)
    publisher.bind(workspace_id="isolation_workspace").emit(RuntimeEventType.CHAT_RUN_CREATED)

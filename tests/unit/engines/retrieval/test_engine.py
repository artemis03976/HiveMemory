...
class TestRetrievalEngine:
    ...
    def test_retrieve_with_render_format(self):
        ...
        self.engine.retrieve(_make_query(), render_format=RenderFormat.XML)
    ...
    def test_retrieve_latency_measured(self):
        """latency_ms 应大于 0"""
        self.mock_retriever.retrieve.return_value = SearchResults(results=[])

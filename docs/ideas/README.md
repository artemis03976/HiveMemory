...
| [Workspace MVP 与 Chat Attachments 初步设计](./workspace-mvp-chat-attachments-design.md) | `v0.6.2 W0/W1` 依赖链、System-owned WorkspaceAssetStore、SemanticBuffer binding、两级状态机与 Artifact provenance | W0 冻结 WorkspaceIdentity/AccessContext、进程内 WorkspaceAsset、READY-only 使用、隔离与迁移；W1 独立处理上传解析、Context Compiler 和 Materialization promotion |

...
> 本文保留被动摄入结构化改造的演化背景，已停止维护。当前 System 侧去重、缓冲、seal、retry 与降级以[被动摄入](../../../system/passive-ingress.md)为准，Patchouli 内部结构化摄入与话题语义以[感知与短期话题](../../../patchouli/perception.md)为准。

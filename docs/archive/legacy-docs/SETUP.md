...
HIVEMEMORY__PATCHOULI__STORAGE__GRPC_PORT=6334
HIVEMEMORY__PATCHOULI__STORAGE__PREFER_GRPC=true
```
...
- `HIVEMEMORY__PATCHOULI__STORAGE__PORT`
...
- Qdrant 容器已正常运行
- Docker Compose 部署时 `HIVEMEMORY__PATCHOULI__STORAGE__HOST=qdrant`
- 本地开发时 `HIVEMEMORY__PATCHOULI__STORAGE__HOST=127.0.0.1`
- `HIVEMEMORY__PATCHOULI__STORAGE__PORT=6333`
